...
const MyOrders = () => {
  return (
    <section>
      <div className='bg-white p-4 text-[#111112] text-[16px] font-[600] shadow-[0_3px_6px_rgb(0_0_0_/_16%)]'>My Orders (2)</div>
        ...
        <div className='ml-4 mr-4 w-[calc(100%-150px-1rem)]'>
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center'>
              <div className='h-[10px] w-[10px] rounded-[50%] bg-[#26a541] border-2 border-soid border-[#26a541]'></div>
              <div className='ml-2 font-[600] text-[#388e3c]'>On the way</div>
            </div>
          </div>
